...
class UAVEnvironment:
    def __init__(self):
        ...
        self.uav_positions = np.random.uniform(0, 3000, (NUM_UAVS, 3))
        self.uav_positions[:, 2] = np.random.uniform(50, 100, NUM_UAVS)  # Set random altitudes
    ...
    def reset(self):
        ...
        self.uav_positions = np.random.uniform(0, 3000, (NUM_UAVS, 3))
        self.uav_positions[:, 2] = np.random.uniform(50, 100, NUM_UAVS)  # Set random altitudes # Update UAV positions at the start of each episode
